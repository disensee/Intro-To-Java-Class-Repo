...
public class ArrayProblemsPart2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int[] scores = {88, 93, 72}; // here's the original array
		int scoreToAdd = 100; // here's the value we want to add to the array
		scores = ArrayProblemsPart2.addElement(scores, scoreToAdd); // invoke the addElement() method like this, and assign the return value to the scores variable
